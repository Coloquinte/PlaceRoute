...
DensityGrid::DensityGrid(std::vector<Rectangle> regions, std::vector<Rectangle> obstacles) {
    regions_ = regions;
...
DensityGrid DensityGrid::fromIspdCircuit(const Circuit &circuit, float sizeFactor) {
